...
async fn unk0(_context: &mut dyn CContext) -> CResult<u32> {
    tracing::warn!("stub unk12_0()");

    Ok(0)
}

async fn unk1(_context: &mut dyn CContext) -> CResult<u32> {
    tracing::warn!("stub unk12_1()");

    Ok(0)
}

async fn unk2(_context: &mut dyn CContext) -> CResult<u32> {
