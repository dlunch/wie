...
#[allow(clippy::too_many_arguments)]
async fn copy_area(context: &mut dyn CContext, dst: CMemoryId, dx: u32, dy: u32, w: i32, h: i32, x: u32, y: u32, pgc: u32) -> CResult<()> {
    ...
    canvas.draw(dx, dy, w as u32, h as u32, &*image, x, y);
