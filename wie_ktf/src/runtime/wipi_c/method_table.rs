...
pub fn get_kernel_interface(context: &mut dyn WIPICContext) -> Result<WIPICKnlInterface> {
    ...
    Ok(WIPICKnlInterface {
        printk: context.make_svc_stub(table_id.function_id(0))?,
        sprintk: context.make_svc_stub(table_id.function_id(1))?,
        get_exec_names: context.make_svc_stub(table_id.function_id(2))?,
        execute: context.make_svc_stub(table_id.function_id(3))?,
        mexecute: context.make_svc_stub(table_id.function_id(4))?,
        load: context.make_svc_stub(table_id.function_id(5))?,
        mload: context.make_svc_stub(table_id.function_id(6))?,
        exit: context.make_svc_stub(table_id.function_id(7))?,
        program_stop: context.make_svc_stub(table_id.function_id(8))?,
        get_cur_program_id: context.make_svc_stub(table_id.function_id(9))?,
        get_parent_program_id: context.make_svc_stub(table_id.function_id(10))?,
        get_app_manager_id: context.make_svc_stub(table_id.function_id(11))?,
        get_program_info: context.make_svc_stub(table_id.function_id(12))?,
        get_access_level: context.make_svc_stub(table_id.function_id(13))?,
        get_program_name: context.make_svc_stub(table_id.function_id(14))?,
        create_shared_buf: context.make_svc_stub(table_id.function_id(15))?,
        destroy_shared_buf: context.make_svc_stub(table_id.function_id(16))?,
        get_shared_buf: context.make_svc_stub(table_id.function_id(17))?,
        get_shared_buf_size: context.make_svc_stub(table_id.function_id(18))?,
        resize_shared_buf: context.make_svc_stub(table_id.function_id(19))?,
        alloc: context.make_svc_stub(table_id.function_id(20))?,
        calloc: context.make_svc_stub(table_id.function_id(21))?,
        free: context.make_svc_stub(table_id.function_id(22))?,
        get_total_memory: context.make_svc_stub(table_id.function_id(23))?,
        get_free_memory: context.make_svc_stub(table_id.function_id(24))?,
        def_timer: context.make_svc_stub(table_id.function_id(25))?,
        set_timer: context.make_svc_stub(table_id.function_id(26))?,
        unset_timer: context.make_svc_stub(table_id.function_id(27))?,
        current_time: context.make_svc_stub(table_id.function_id(28))?,
        get_system_property: context.make_svc_stub(table_id.function_id(29))?,
        set_system_property: context.make_svc_stub(table_id.function_id(30))?,
        get_resource_id: context.make_svc_stub(table_id.function_id(31))?,
        get_resource: context.make_svc_stub(table_id.function_id(32))?,
        reserved1: context.make_svc_stub(table_id.function_id(33))?,
        reserved2: context.make_svc_stub(table_id.function_id(34))?,
        reserved3: context.make_svc_stub(table_id.function_id(35))?,
        reserved4: context.make_svc_stub(table_id.function_id(36))?,
        reserved5: context.make_svc_stub(table_id.function_id(37))?,
        reserved6: context.make_svc_stub(table_id.function_id(38))?,
        reserved7: context.make_svc_stub(table_id.function_id(39))?,
        reserved8: context.make_svc_stub(table_id.function_id(40))?,
        reserved9: context.make_svc_stub(table_id.function_id(41))?,
        reserved10: context.make_svc_stub(table_id.function_id(42))?,
        reserved11: context.make_svc_stub(table_id.function_id(43))?,
        send_message: context.make_svc_stub(table_id.function_id(44))?,
        set_timer_ex: context.make_svc_stub(table_id.function_id(45))?,
        get_system_state: context.make_svc_stub(table_id.function_id(46))?,
        create_system_progress_bar: context.make_svc_stub(table_id.function_id(47))?,
        set_system_progress_bar: context.make_svc_stub(table_id.function_id(48))?,
        destroy_system_progress_bar: context.make_svc_stub(table_id.function_id(49))?,
        execute_ex: context.make_svc_stub(table_id.function_id(50))?,
        get_proc_address: context.make_svc_stub(table_id.function_id(51))?,
        unload: context.make_svc_stub(table_id.function_id(52))?,
        create_sys_message_box: context.make_svc_stub(table_id.function_id(53))?,
        destroy_sys_message_box: context.make_svc_stub(table_id.function_id(54))?,
        get_program_id_list: context.make_svc_stub(table_id.function_id(55))?,
        get_program_info2: context.make_svc_stub(table_id.function_id(56))?,
        reserved12: context.make_svc_stub(table_id.function_id(57))?,
        reserved13: context.make_svc_stub(table_id.function_id(58))?,
        create_app_private_area: context.make_svc_stub(table_id.function_id(59))?,
        get_app_private_area: context.make_svc_stub(table_id.function_id(60))?,
        create_lib_private_area: context.make_svc_stub(table_id.function_id(61))?,
        get_lib_private_area: context.make_svc_stub(table_id.function_id(62))?,
        get_platform_version: context.make_svc_stub(table_id.function_id(63))?,
        get_token: context.make_svc_stub(table_id.function_id(64))?,
    })
}
...
pub fn get_graphics_interface(context: &mut dyn WIPICContext) -> Result<WIPICGraphicsInterface> {
    ...
    Ok(WIPICGraphicsInterface {
        get_image_property: context.make_svc_stub(table_id.function_id(0))?,
        get_image_framebuffer: context.make_svc_stub(table_id.function_id(1))?,
        get_screen_framebuffer: context.make_svc_stub(table_id.function_id(2))?,
        destroy_offscreen_framebuffer: context.make_svc_stub(table_id.function_id(3))?,
        create_offscreen_framebuffer: context.make_svc_stub(table_id.function_id(4))?,
        init_context: context.make_svc_stub(table_id.function_id(5))?,
        set_context: context.make_svc_stub(table_id.function_id(6))?,
        get_context: context.make_svc_stub(table_id.function_id(7))?,
        put_pixel: context.make_svc_stub(table_id.function_id(8))?,
        draw_line: context.make_svc_stub(table_id.function_id(9))?,
        draw_rect: context.make_svc_stub(table_id.function_id(10))?,
        fill_rect: context.make_svc_stub(table_id.function_id(11))?,
        copy_frame_buffer: context.make_svc_stub(table_id.function_id(12))?,
        draw_image: context.make_svc_stub(table_id.function_id(13))?,
        copy_area: context.make_svc_stub(table_id.function_id(14))?,
        draw_arc: context.make_svc_stub(table_id.function_id(15))?,
        fill_arc: context.make_svc_stub(table_id.function_id(16))?,
        draw_string: context.make_svc_stub(table_id.function_id(17))?,
        draw_unicode_string: context.make_svc_stub(table_id.function_id(18))?,
        get_rgb_pixels: context.make_svc_stub(table_id.function_id(19))?,
        set_rgb_pixels: context.make_svc_stub(table_id.function_id(20))?,
        flush_lcd: context.make_svc_stub(table_id.function_id(21))?,
        get_pixel_from_rgb: context.make_svc_stub(table_id.function_id(22))?,
        get_rgb_from_pixel: context.make_svc_stub(table_id.function_id(23))?,
        get_display_info: context.make_svc_stub(table_id.function_id(24))?,
        repaint: context.make_svc_stub(table_id.function_id(25))?,
        get_font: context.make_svc_stub(table_id.function_id(26))?,
        get_font_height: context.make_svc_stub(table_id.function_id(27))?,
        get_font_ascent: context.make_svc_stub(table_id.function_id(28))?,
        get_font_descent: context.make_svc_stub(table_id.function_id(29))?,
        get_string_width: context.make_svc_stub(table_id.function_id(30))?,
        get_unicode_string_width: context.make_svc_stub(table_id.function_id(31))?,
        create_image: context.make_svc_stub(table_id.function_id(32))?,
        destroy_image: context.make_svc_stub(table_id.function_id(33))?,
        decode_next_image: context.make_svc_stub(table_id.function_id(34))?,
        encode_image: context.make_svc_stub(table_id.function_id(35))?,
        post_event: context.make_svc_stub(table_id.function_id(36))?,
        handle_input: context.make_svc_stub(table_id.function_id(37))?,
        set_current_mode: context.make_svc_stub(table_id.function_id(38))?,
        get_current_mode: context.make_svc_stub(table_id.function_id(39))?,
        get_support_mode_count: context.make_svc_stub(table_id.function_id(40))?,
        get_supported_modes: context.make_svc_stub(table_id.function_id(41))?,
        fill_polygon: context.make_svc_stub(table_id.function_id(42))?,
        draw_polygon: context.make_svc_stub(table_id.function_id(43))?,
        show_annunciator: context.make_svc_stub(table_id.function_id(44))?,
        get_annunciator_info: context.make_svc_stub(table_id.function_id(45))?,
        set_annunciator_icon: context.make_svc_stub(table_id.function_id(46))?,
        get_idle_help_line_info: context.make_svc_stub(table_id.function_id(47))?,
        show_help_line: context.make_svc_stub(table_id.function_id(48))?,
        get_char_glyph: context.make_svc_stub(table_id.function_id(49))?,
        create_image_ex: context.make_svc_stub(table_id.function_id(50))?,
        hide_help_line: context.make_svc_stub(table_id.function_id(51))?,
        set_clone_screen_framebuffer: context.make_svc_stub(table_id.function_id(52))?,
        get_font_ex: context.make_svc_stub(table_id.function_id(53))?,
        get_font_lists: context.make_svc_stub(table_id.function_id(54))?,
        get_font_info: context.make_svc_stub(table_id.function_id(55))?,
        set_font_help_line: context.make_svc_stub(table_id.function_id(56))?,
        get_font_help_line: context.make_svc_stub(table_id.function_id(57))?,
        encode_image_ex: context.make_svc_stub(table_id.function_id(58))?,
        get_image_info: context.make_svc_stub(table_id.function_id(59))?,
    })
}
...
pub fn get_database_interface(context: &mut dyn WIPICContext) -> Result<WIPICDatabaseInterface> {
    ...
    Ok(WIPICDatabaseInterface {
        open_database: context.make_svc_stub(table_id.function_id(0))?,
        read_record_single: context.make_svc_stub(table_id.function_id(1))?,
        write_record_single: context.make_svc_stub(table_id.function_id(2))?,
        close_database: context.make_svc_stub(table_id.function_id(3))?,
        select_record: context.make_svc_stub(table_id.function_id(4))?,
        update_record: context.make_svc_stub(table_id.function_id(5))?,
        delete_record: context.make_svc_stub(table_id.function_id(6))?,
        list_record: context.make_svc_stub(table_id.function_id(7))?,
        sort_records: context.make_svc_stub(table_id.function_id(8))?,
        get_access_mode: context.make_svc_stub(table_id.function_id(9))?,
        get_number_of_records: context.make_svc_stub(table_id.function_id(10))?,
        get_record_size: context.make_svc_stub(table_id.function_id(11))?,
        list_databases: context.make_svc_stub(table_id.function_id(12))?,
        unk13: context.make_svc_stub(table_id.function_id(13))?,
        unk14: context.make_svc_stub(table_id.function_id(14))?,
        unk15: context.make_svc_stub(table_id.function_id(15))?,
        unk16: context.make_svc_stub(table_id.function_id(16))?,
    })
}
