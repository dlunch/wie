...
impl System {
    ...
    pub fn ptr_random_state(&self) -> u32 {
        self.ptr_random_state
    }

    pub fn set_ptr_random_state(&mut self, ptr_random_state: u32) {
        self.ptr_random_state = ptr_random_state;
    }
