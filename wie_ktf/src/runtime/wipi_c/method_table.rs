...
pub fn get_method_body(table_id: WIPICTableId, function_id: u16) -> Option<WIPICMethodBody> {
    match table_id {
        ...
        WIPICTableId::Graphics => match WIPICGraphicsMethodId::try_from(function_id).ok()? {
            ...
            WIPICGraphicsMethodId::GetImageFramebuffer => Some(gen_stub(1, "MC_grpGetImageFrameBuffer")),
            ...
            WIPICGraphicsMethodId::GetRgbPixels => Some(gen_stub(19, "MC_grpGetRGBPixels")),
            WIPICGraphicsMethodId::SetRgbPixels => Some(gen_stub(20, "MC_grpSetRGBPixels")),
            ...
            WIPICGraphicsMethodId::GetFontAscent => Some(gen_stub(28, "MC_grpGetFontAscent")),
            WIPICGraphicsMethodId::GetFontDescent => Some(gen_stub(29, "MC_grpGetFontDescent")),
