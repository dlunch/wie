...
async fn get_java_method(core: &mut ArmCore, system: &mut System, ptr_class: u32, ptr_fullname: u32) -> anyhow::Result<u32> {
...
async fn get_static_field(core: &mut ArmCore, system: &mut System, ptr_class: u32, field_name: u32) -> anyhow::Result<u32> {
