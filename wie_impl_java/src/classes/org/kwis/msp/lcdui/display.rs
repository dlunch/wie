...
impl Display {
    ...
    async fn get_display(jvm: &mut Jvm, _: &mut JavaContextArg, str: JvmClassInstanceHandle<String>) -> JavaResult<JvmClassInstanceHandle<Self>> {
    ...
    async fn get_default_display(jvm: &mut Jvm, _: &mut JavaContextArg) -> JavaResult<JvmClassInstanceHandle<Display>> {
    ...
    async fn get_docked_card(_: &mut Jvm, _: &mut JavaContextArg) -> JavaResult<JvmClassInstanceHandle<Card>> {
    ...
    async fn remove_all_cards(jvm: &mut Jvm, _: &mut JavaContextArg, mut this: JvmClassInstanceHandle<Self>) -> JavaResult<()> {
    ...
    async fn call_serially(
        ...
        impl MethodBody<JavaError, JavaContextArg> for SpawnProxy {
            async fn call(&self, jvm: &mut Jvm, context: &mut JavaContextArg, _: Box<[JavaValue]>) -> Result<JavaValue, JavaError> {
    ...
    async fn get_game_action(_: &mut Jvm, _: &mut JavaContextArg, key: i32) -> JavaResult<i32> {
