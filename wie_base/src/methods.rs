...
macro_rules! __impl_method_body {
    ($context: ident, $raw_type: ty, $($arg: ident),*) => {
        ...
        where
            ...
            R: TypeConverter<R>,
        {
            async fn call(&self, context: &mut dyn $context, args: &[$raw_type]) -> Result<$raw_type, E> {
...
macro_rules! __generate {
    ($context: ident, $raw_type: ty, $($arg: ident),*) => {
        $crate::__impl_fn_helper!($context, $raw_type, $($arg),*);
        $crate::__impl_method_body!($context, $raw_type, $($arg),*);
...
macro_rules! methods {
    ($context: ident, $raw_type: ty) => {
        ...
        $crate::__generate!($context, $raw_type,);
        $crate::__generate!($context, $raw_type, P0);
        $crate::__generate!($context, $raw_type, P0, P1);
        $crate::__generate!($context, $raw_type, P0, P1, P2);
        $crate::__generate!($context, $raw_type, P0, P1, P2, P3);
        $crate::__generate!($context, $raw_type, P0, P1, P2, P3, P4);
        $crate::__generate!($context, $raw_type, P0, P1, P2, P3, P4, P5);
        $crate::__generate!($context, $raw_type, P0, P1, P2, P3, P4, P5, P6);
        $crate::__generate!($context, $raw_type, P0, P1, P2, P3, P4, P5, P6, P7);
        $crate::__generate!($context, $raw_type, P0, P1, P2, P3, P4, P5, P6, P7, P8);
    };
}
